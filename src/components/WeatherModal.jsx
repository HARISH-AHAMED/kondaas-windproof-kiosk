        ...
        <>
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md transition-opacity">
                    {/* Modal Content - TV Kiosk Look */}
                    <div className="bg-slate-900 border-4 border-white/20 rounded-3xl p-6 md:p-8 shadow-[0_0_40px_rgba(0,0,0,0.8)] flex flex-col items-center max-w-xl w-full mx-4 relative max-h-[95vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="w-full flex flex-col items-center">
                            {mode === 'district' ? (
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                className="w-full h-20 bg-black/50 border-4 border-white/20 rounded-2xl px-6 py-2 text-3xl font-bold text-white appearance-none cursor-pointer focus:border-red-500 outline-none transition-all"
                                            >
                                ...
                                <>
                                    ...
                                    <div
                                        className="w-full h-20 bg-black/50 border-4 border-white/20 rounded-2xl px-6 py-2 text-center text-4xl font-mono text-white tracking-[0.25em] mb-6 flex items-center justify-center overflow-hidden"
                                    >
