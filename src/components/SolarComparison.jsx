            ...
            <div className="absolute inset-0 z-10 flex w-full h-full pb-[140px] md:pb-[180px]">
                ...
                <div className="w-1/2 h-full relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 pointer-events-none z-20">
                        {/* Top Left Feature */}
                        <div className="absolute top-[18%] left-[4%] flex items-center gap-1">
                        ...
                        {/* Mid Left Feature */}
                        <div className="absolute top-[32%] left-[4%] flex items-center gap-1">
                            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#003366] border-2 border-[#4da6ff] flex items-center justify-center shadow-[0_0_15px_rgba(77,166,255,0.6)]">
                        ...
                        {/* Top Right Feature */}
                        <div className="absolute top-[18%] right-[4%] flex items-center gap-1 flex-row-reverse text-right">
                            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#003366] border-2 border-[#4da6ff] flex items-center justify-center shadow-[0_0_15px_rgba(77,166,255,0.6)]">
                        ...
                        {/* Mid Right Feature */}
                        <div className="absolute top-[32%] right-[4%] flex items-center gap-1 flex-row-reverse text-right">
                            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#003366] border-2 border-[#4da6ff] flex items-center justify-center shadow-[0_0_15px_rgba(77,166,255,0.6)]">
